...
// déclaration des constantes d'application
...
// Déclaration des controllers (un par variable)
var mainController = function($http, $scope, $rootScope, clientFactory, countryFactory){
...
var clientController = function($scope, $rootScope, $routeParams, $interval, clientFactory, testService, SETTINGS){
...
// Enregistrement des controllers auprès du module
angular.module("testApp")
  .controller("mainController", mainController)
  .controller("menuController", menuController)
  .controller("clientController", clientController);

// Protection en cas de minification
mainController.$inject = ['$http', '$scope', '$rootScope', 'clientFactory', 'countryFactory'];
menuController.$inject = ['$scope'];
clientController.$inject = ['$scope', '$rootScope', '$routeParams', '$interval', 'clientFactory', 'testService', 'SETTINGS'];
